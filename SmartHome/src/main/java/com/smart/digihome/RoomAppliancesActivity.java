...
public class RoomAppliancesActivity extends AppCompatActivity implements DevicesListDialog.MenuClickListener, Constants {

    ImageView imageView;
    TextView mRoomNametextView, applicanceaddguide;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRoomNametextView = findViewById(R.id.roomName);
        ...
        String roomName = getIntent().getExtras().getString(KEY_ROOM_NAME);
